...
const PlaceOrder = () => {
  ...
  const { navigate,backendUrl,token,cartItems,setCartItems,getCartamount,delivery_fee,productData } = useContext(ShopContext);
  ...
  return (
    ...
    {/* left side */}
      <div className='flex flex-col w-full gap-4 sm:max-w-[480px]'>
        ...
        <input onChange={onChangeHandler} name='street' value={formData.street} className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type="text" placeholder='Apartment no , Street' required/>
        <div className='flex gap-3'>
        ...
        <div className='flex gap-3'>
          <input onChange={onChangeHandler} name='zipcode' value={formData.zipcode} className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type="number" placeholder='Pincode' required/>
