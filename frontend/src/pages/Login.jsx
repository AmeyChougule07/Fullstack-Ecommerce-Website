...
const Login = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} action="" className='flex flex-col text-center w-[90%] sm:max-w-96 m-auto mt-14 gap-4 text-gray-800'>
      ...
      <button className='cursor-pointer bg-black text-white font-light px-8 py-2 mt-4'>{currentState === 'Login' ? 'Log In' : 'Sign Up'}</button>
    </form>
  )
}
